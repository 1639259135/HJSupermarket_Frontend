<template>
  <div class="page">
    <el-card>
      <template #header>新建销售单</template>
      <el-form ref="formRef" :model="form" label-width="80px" style="max-width:700px">
        ...
        <el-button style="margin-top:8px" @click="form.items.push({productId:0,quantity:1,price:0})">+ 添加商品</el-button>
...
async function handleSubmit() {
  ...
  s.value = true
  try {
    await createSale({ storeId: form.storeId!, items: form.items })
